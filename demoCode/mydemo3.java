...
//    Suppose we have a table students(sid, firstname, lastname, 
status, 
//    gpa, email), and a stored function called getstudents in a 
package, 
//    which returns all students records. 
//    To return a result set from a stored procedure, you must use a 
//    cursor variable. Cursor variables are basically pointers to 
cursors, 
//    and you use them to pass around references to cursors, such as a 
//    parameter to a stored procedure. The PL/SQL type of a cursor 
variable 
//    is REF CURSOR.
//
...
ds.setURL("jdbc:oracle:thin:@grouchoIII.cc.binghamton.edu:1521:ACAD111");
        Connection conn = ds.getConnection("your-userid", 
"your-password");

        //Prepare to call stored procedure:
        CallableStatement cs = conn.prepareCall("begin ? := 
refcursor_jdbc1.getstudents(); end;");
